...
| Code | Subject | Folder |
|---|---|---|
| MA3321 | Transforms and Partial Differential Equations | `MA3321 - Transforms and Partial Differential Equations/` |
| EC3362 | Solid State Devices and Circuits | `EC3362 - Solid State Devices and Circuits/` |
| EC3363 | Signals and Systems | `EC3363 - Signals and Systems/` |
| EE3363 | Electric Circuit Analysis | `EE3363 - Electric Circuit Analysis/` |
| EC3365 | Electromagnetic Fields | `EC3365 - Electromagnetic Fields/` |
| EC3366 | Digital Systems Design | `EC3366 - Digital Systems Design/` |
...
Theory subjects have `notes/` and `question-banks/`; lab subjects have `lab-manuals/`. Each subject's own README holds that subject's syllabus; the full semester list is in [Curriculum.md](Curriculum.md).
...
**4. Add your file.** Drag your notes file into the subject's `notes/` folder (lab subjects use `lab-manuals/`). Name it `Unit-<n>-<topic>-<your-name>.md` or `...-<your-name>.pdf` — both are accepted.
...
git add "EC3363 - Signals and Systems/notes/Unit-2-Fourier-rahul.pdf"   # 3. stage your file
...
- Subject folder names contain spaces, so wrap the path in quotes as shown above.
